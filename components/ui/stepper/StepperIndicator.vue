...
<template>
  <StepperIndicator
    ...
    :class="cn(
      ...
      // Disabled
      'group-data-[disabled]:text-muted-foreground group-data-[disabled]:opacity-50 border border-indigo-600',
      // Active
      'group-data-[state=active]:bg-indigo-600 group-data-[state=active]:text-primary-foreground',
      // Completed
